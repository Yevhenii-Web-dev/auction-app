...
@section('content')
    <div class="flex justify-center">
        <div
            ...
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $lot->name }}</h5>
            <p class="mb-3 min-h-[50px] font-normal text-gray-700 dark:text-gray-400">{{ $lot->description ?? __('There is no description') }}</p>
            <div class="mb-6">
